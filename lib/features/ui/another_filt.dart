...
class Filtration extends StatelessWidget {
  final String? title ;
  final int index ;
  Filtration({required this.title,required this.index});

  getWhichDetailedFiltr(String? title ,BuildContext context,int index) {
        ...
        body: BlocConsumer<ClinicCubit,ClinicStates>(
            ...
            builder:(context, state)
            {
              ...
              return  SingleChildScrollView(
                ...
                child: getWhichDetailedFiltr(title.toString(), context,index),
              );
        ...
        Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.of(context).pushReplacement(SliderRight(page: EnteredTest(title: title,)));
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    cli.phoneNumber.toString() == null ||   cli.phoneNumber.toString() == 'null' ?  'لا يوجد رقم هاتف'
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 5.w,),
                  Text(
                    cli.phoneNumbe2r.toString() == null || cli.phoneNumbe2r.toString() == 'null' ?  'لا يوجد رقم اخر' : cli.phoneNumbe2r.toString()  ,style: GoogleFonts.tajawal(
                    fontSize: 16.sp,
                    color: mainLineColor,
                  ),
