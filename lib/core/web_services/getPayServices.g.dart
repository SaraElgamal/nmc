...
class _PayServices implements PayServices {
  _PayServices(
    this._dio, {
    this.baseUrl,
  }) {
    baseUrl ??= 'https://app.fawaterk.com/';
  }
  ...
  Future<PaymentMethod> getPayment() async {
    ...
    final _headers = <String, dynamic>{
      ...
      r'Authorization':
          'Bearer 5e1e355f65f639da2dce8757191933f3b1b0039dcc56e6ceeb',
    };
